                ...
                products.map(function (product) {
                    ...
                    return (React.createElement(components_1.Section, { key: product.id },
                        ...
                        React.createElement(components_1.Column, { style: { paddingLeft: "22px" } },
                            ...
                            product.description ? React.createElement(components_1.Text, { style: productDescription }, product.description.length > 50 ? ((_a = product.description) === null || _a === void 0 ? void 0 : _a.slice(0, 50)) + "..." : product.description) : null,
