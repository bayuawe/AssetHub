  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-muted-foreground text-sm">This token is not valid or might be expired. Pleas try again</p>
      </div>
    );
  }
  ...
  if (data?.sucess) {
    return (
      <div className="flex h-full flex-col items-center justify-center">
        ...
        <h3 className="font-semibold tex-2xl "> You&apos;re all set!</h3>
