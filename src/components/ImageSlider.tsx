...
const ImageSlider = ({ urls }: ImageSliderProps) => {
  ...
  const activeStyles = "active:scale-[0.97] grid opacity-100 hover:sclae-105 absolute top-1/2 -translate-y-1/2 aspect-square h-8 w-8 z-50 place-items-center rounded-full border-2 bg-white border-zinc-300";
